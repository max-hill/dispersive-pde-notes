...
Recall we are doing the GWPfor energy critical NLS. We are doing dimension $n=4$
...
First, \textbf{Property 1 (Lemma 8.3[V])} says that your solution will be concentrated in a rectangle
about $(x_{0},t_{0})$, with dimensions $H^{-2}$ and $H^{-1}(t_{0})$.
...
\begin{figure}[h]
  ...
  \label{fig:lem8.3}
\end{figure}
\textbf{Property 2 (Lemma 8.4[V])} says that the space-time norm of the solution is concentrated in
adjacent rectangles.
\begin{center}
  \begin{figure}[h]
...
We claim that as $T \to \infty$, $N(t)\to \infty$. \pnote{This section got
  garbled as I tried to figure out how to add pictures.}


And also \textbf{Property 3 (Lemma 8.5[V])} which says that the Strichartz norms of the
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=.5]{Visan-Lemma-8.5}
  \caption{Property 3 (Lemma 8.5 in Visan)}
  \label{fig:lem8.5}
\end{figure}

Then \textbf{Lemma 8.6[V]} will give a similar bound
\begin{equation*}
  \norm{u}_{L_{t}^{2}L^{\frac{2d}{d-2}}} \leq 1 + \int_{I}N(t)^{2}dt 
\end{equation*}

and then \textbf{Proposition 8.6[V] (Duhamel Reduced)} (see \cref{fig:lem8.6},
this is essential for proving long-time Strichartz, but not used elsewhere).

\begin{figure}[h]
  \centering
  \includegraphics[scale=.5]{Duhamel-Reduced}
  \caption{Lemma 8.6[V]}
  \label{fig:lem8.6}
\end{figure}
